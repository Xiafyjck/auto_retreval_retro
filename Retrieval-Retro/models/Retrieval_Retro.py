...
class Retrieval_Retro(nn.Module):
    def __init__(self, gnn, layers, input_dim, output_dim, hidden_dim, n_bond_feat, device, t_layers, t_layers_sa, num_heads):
        ...
        self.fusion_linear = nn.Sequential(nn.Linear(2*hidden_dim, hidden_dim), nn.PReLU())
        ...
        self.fusion_linear_2 = nn.Sequential(nn.Linear(2*hidden_dim, hidden_dim), nn.PReLU())
